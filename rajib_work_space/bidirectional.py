...
# -------------------- ARGUMENT PARSING --------------------
def parse_args():
    parser = argparse.ArgumentParser(description="Fine-tuned Chronos-2 SMD Bidirectional Anomaly Detection (VUS metrics)")
    parser.add_argument(
        "--split_ratio",
        type=float,
        default=0.2,
    ...
    parser.add_argument(
        ...
        type=int,
        default=24,
        help="Chronos will predict timestamps (matches fine-tuning horizon)"
    )
    parser.add_argument(
        "--context_length",
        type=int,
    ...
    parser.add_argument(
        "--output_csv",
        type=str,
        default="results_finetuned_bidirectional.csv",
...
CKPT_PATH = "/home/rajib/chronos-forecasting/chronos2-finetuned/checkpoint-8000"
